# copied directly from https://github.com/defunkt/colored/blob/master/lib/colored.rb
# purely so we don't need the gem to be installed, removing a dependency for the install process
